            ...
            <div class="card-body">
                <div class="profile-header">
                    ...
                    <div class="profile-info">
                        <h3>Ekiyor Clifford</h3>
                        <p><i class="fas fa-envelope"></i> ekiyorclifford@gmail.com</p>
                        <p><i class="fas fa-phone"></i> +234 811 2177 604</p>
                        <p><i class="fas fa-map-marker-alt"></i> New Lagos, LG</p>
                        <div class="profile-meta">
                            <span class="meta-item"><i class="fas fa-calendar-alt"></i> Member since 2022</span>
