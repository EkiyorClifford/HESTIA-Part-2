(function () {
  ...
  /**
   * Navigation Timing is reliable only after the window "load" event; on DOMContentLoaded
   * performance.getEntriesByType("navigation") is often still empty, so reload never cleared premium.
   */
