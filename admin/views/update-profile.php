            ...
            <div class="profile-editor-shell">
                <section class="profile-intro-card">
                    ...
                    <div class="identity-chip">
                        <div class="avatar-badge"><?= htmlspecialchars(strtoupper(substr($admin_data['first_name'], 0, 1))) ?></div>
                        <div>
                            <strong><?= htmlspecialchars($admin_data['first_name'] . ' ' . $admin_data['last_name']) ?></strong>
                            <span><?= htmlspecialchars(ucfirst($admin_data['role'])) ?></span>
                        </div>
                    </div>
                ...
                <section class="profile-form-card">
                    ...
                    <form action="../process/process_update_profile.php" method="POST" class="row g-4">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="fname" name="fname" value="<?= htmlspecialchars($admin_data['first_name']) ?>" required>
                        </div>

                        <div class="col-md-6">
                            <label for="lname" class="form-label">Last Name</label>
                            <input type="text" class="form-control" id="lname" name="lname" value="<?= htmlspecialchars($admin_data['last_name']) ?>" required>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="phone" name="phone" value="NULL" required>
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            <div class="readonly-pill"><?= htmlspecialchars(ucfirst($admin_data['role'])) ?></div>
                        </div>
